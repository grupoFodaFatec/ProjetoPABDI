		...
		<div class="form">
			...
			<div class="form-wrap">
				<form:form class="sign" action="/login" commandName="user">
					...
					<input id="login" name="login" type="text" maxlength="60" placeholder="Login"
					       title="Por favor, preencha seu login" required autofocus autocomplete="off">
					...
					<p>
						<a href="#modal">Esqueceu a sua Senha?</a>
						<br />
						<br />
	...
	<div id="modal">
		<div class="modal-content">
			<div class="modal-header">
				<a href="/index"><i class="fa fa-times"></i></a>
